...
export default function Map() {
	...
	useGSAP(() => {
		const panels = gsap.utils.toArray(".mapText");
		...
		const textTL = gsap.timeline({ defaults: { duration: 1 } })
			.from("#PA", {yPercent: 100 })
			.to("#PA", {yPercent: -100 })
			.from("#OH", {yPercent: 100 }, "-=1")
			.to("#OH", {yPercent: -100 })
			.from("#NY", {yPercent: 100}, "-=1")
	...
	return (
		<div id="scroll-wrapper">
			<main id="smooth-content">
				...
				<section className="mapContainer" ref={map}>			
					...
					<div className="mapText">
						{/* <div className="">&nbsp;</div> */}
						<div id="PA" className="">PA</div>
						<div id="OH" className="">OH</div>
						<div id="NY" className="">NY</div>
					</div>

					{/* <div id="end" className="mapText">end</div> */}
				</section>

				<section className="textContainer" style={{ minHeight: "400vh" }}>
					<p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Quisque faucibus ex sapien vitae pellentesque sem placerat. In id cursus mi pretium tellus duis convallis. Tempus leo eu aenean sed diam urna tempor. Pulvinar vivamus fringilla lacus nec metus bibendum egestas. Iaculis massa nisl malesuada lacinia integer nunc posuere. Ut hendrerit semper vel class aptent taciti sociosqu. Ad litora torquent per conubia nostra inceptos himenaeos.</p>
					<p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Quisque faucibus ex sapien vitae pellentesque sem placerat. In id cursus mi pretium tellus duis convallis. Tempus leo eu aenean sed diam urna tempor. Pulvinar vivamus fringilla lacus nec metus bibendum egestas. Iaculis massa nisl malesuada lacinia integer nunc posuere. Ut hendrerit semper vel class aptent taciti sociosqu. Ad litora torquent per conubia nostra inceptos himenaeos.</p>
					<p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Quisque faucibus ex sapien vitae pellentesque sem placerat. In id cursus mi pretium tellus duis convallis. Tempus leo eu aenean sed diam urna tempor. Pulvinar vivamus fringilla lacus nec metus bibendum egestas. Iaculis massa nisl malesuada lacinia integer nunc posuere. Ut hendrerit semper vel class aptent taciti sociosqu. Ad litora torquent per conubia nostra inceptos himenaeos.</p>
					<p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Quisque faucibus ex sapien vitae pellentesque sem placerat. In id cursus mi pretium tellus duis convallis. Tempus leo eu aenean sed diam urna tempor. Pulvinar vivamus fringilla lacus nec metus bibendum egestas. Iaculis massa nisl malesuada lacinia integer nunc posuere. Ut hendrerit semper vel class aptent taciti sociosqu. Ad litora torquent per conubia nostra inceptos himenaeos.</p>
